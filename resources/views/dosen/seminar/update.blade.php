...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ubah Seminar Dan Pelatihan</h1>
        </div>

        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <a href="/form-seminardanpelatihan-dosen" class="btn btn-sm btn-warning">Back</a>
            <form action="/form-seminardanpelatihan-dosen/updateData/{{ $seminar->id_seminardanpelatihan }}" method="POST">
                @method('put')
                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" placeholder="Isi Tema Seminar/Pelatihan"
                                        name="tema_seminardanpelatihan" value="{{ $seminar->tema_seminardanpelatihan }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="date" class="form-control" placeholder="Isi Tanggal Seminar/Pelatihan"
                                        ...
                                        value="{{ date('Y-m-d', strtotime($seminar->tanggal_seminardanpelatihan)) }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" class="form-control" placeholder="Isi Lokasi Seminar/Pelatihan"
                                        ...
                                        value="{{ $seminar->lokasi_seminardanpelatihan }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
