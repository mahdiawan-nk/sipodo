...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            ...
            <form action="/form-patendanHaKi-dosen/updateData/{{ $paten->id_patendanhaki }}" method="POST">
                @method('put')
                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" class="form-control" placeholder="Isi Tanggal Terima"
                                        ...
                                        value="{{ date('Y-m-d', strtotime($paten->tanggal_terima)) }}">
                                </td>
                            </tr>
